...
import { WHY_BUILDNEST_DATA } from "@/data/whyBuildnestData";
...
export default function WhyBuildnest() {
  ...
  return (
    <section
      id="why-us"
      ref={sectionRef}
      className="relative py-12 sm:py-16 lg:py-28 bg-bg-luxury border-b border-border-luxury/50 overflow-hidden"
    >
      ...
      <div className="mx-auto max-w-[1440px] px-5 sm:px-10 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {WHY_BUILDNEST_DATA.map((param, idx) => (
              <motion.div
                key={param.title}
