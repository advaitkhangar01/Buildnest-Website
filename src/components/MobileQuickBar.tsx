    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-[calc(1rem+env(safe-area-inset-bottom,0px))] left-3 right-3 min-[390px]:left-4 min-[390px]:right-4 z-40 md:hidden pointer-events-auto"
        >
          <div className="bg-[#121518]/92 backdrop-blur-2xl border border-white/20 p-1.5 min-[375px]:p-2 rounded-2xl shadow-3d-dark flex items-center justify-between gap-1.5 min-[375px]:gap-2 specular-border-dark">
            ...
            <Link
              href="/contact"
              className="py-2.5 px-2.5 min-[375px]:px-3.5 bg-accent hover:bg-accent/90 rounded-xl text-white text-[10px] min-[375px]:text-[11px] font-bold tracking-wider uppercase flex items-center justify-center transition-all active:scale-95 shrink-0"
            >
              Inquire ↗
            </Link>
          </div>
